...
def test_interpolate_field_1D_linear_potential():
    ...
    interpolated_field = InterpolateField([x_vec], phi_on_grid)
    pts = [0, 0.5, 1]
    evaluated_field = interpolated_field.ev(pts)
...
def test_interpolate_field_2D_null_field():
    ...
    evaluated_field = interpolated_field.ev([0.5] * 2)
...
def test_interpolate_field_2D_linear_potential():
    ...
    pts = [0.5, 0.5]
    evaluated_field1 = interpolated_field1.ev(pts)
    evaluated_field2 = interpolated_field2.ev(pts)
